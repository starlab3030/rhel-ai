...
모델이 도메인별 정보를 학습할 수 있도록 택소노미 트리를 사용자 지정할 수 있습니다. RHEL AI의 경우, 지식 데이터는 Git 저장소에 호스팅됩니다. 지식 기여는 qna.yaml 파일을 사용하여 모델에 가르치려는 문서를 읽는 방법을 학습합니다. 지식에 대한 각 qna.yaml 파일에는 다음 키가 있는 키-값 항목 세트가 포함되어 있습니다.
<br>
<br>
